### v3.7.0 [view commit logs](https://github.com/soomla/android-store/compare/v3.6.1...v3.7.0)
***Important***: this is a breaking release for Amazon IAP users. Read the changes carefully.
* Changes:
