...
public class MuffinRushAssets implements IStoreAssets {
    ...
    public static final String FORHUNDMUFF_PACK_PRODUCT_ID = "android.test.purchased";
    ...
    public static final VirtualCurrencyPack TENMUFF_PACK = new VirtualCurrencyPack(
            ...
            MUFFIN_CURRENCY,                                // the currency associated with this pack
    ...
    public static final VirtualCurrencyPack FORHUNDMUFF_PACK = new VirtualCurrencyPack(
            "400 Muffins",                                  // name
            "Test purchase of an item",                     // description
            "muffins_400",                                  // item id
            400,                                            // number of currencies in the pack
            MUFFIN_CURRENCY,                                // the currency associated with this pack
            new PurchaseWithMarket(FORHUNDMUFF_PACK_PRODUCT_ID, 4.99));
    ...
    public static final VirtualGood MUFFINCAKE_GOOD = new SingleUseVG(
            ...
            "fruit_cake",                                       // item id
            new PurchaseWithVirtualItem(MUFFIN_CURRENCY, 225)); // the way this virtual good is purchased
    ...
    public static final VirtualGood PAVLOVA_GOOD = new SingleUseVG(
            ...
            "pavlova",                                          // item id
            new PurchaseWithVirtualItem(MUFFIN_CURRENCY, 175)); // the way this virtual good is purchased
    ...
    public static final VirtualGood CHOCLATECAKE_GOOD = new SingleUseVG(
            ...
            new PurchaseWithVirtualItem(MUFFIN_CURRENCY, 250)); // the way this virtual good is purchased
    ...
    public static final VirtualCategory GENERAL_CATEGORY = new VirtualCategory(
            "General", new ArrayList<VirtualGood>(Arrays.asList(new VirtualGood[] { MUFFINCAKE_GOOD, PAVLOVA_GOOD, CHOCLATECAKE_GOOD, CREAMCUP_GOOD }))
    );
