...
/**
 * A <code>SubscriptionVG</code> is a virtual good that is bought once and kept forever.
 *
 * The <code>SubscriptionVG</code>'s characteristics are:
 ...
 *
 * Inheritance: SubscriptionVG >
 * {@link LifetimeVG} >
 * {@link VirtualGood} >
 * {@link PurchasableVirtualItem} >
 * {@link VirtualItem}
 */
public class SubscriptionVG extends LifetimeVG {
     ...
     */
    public SubscriptionVG(String mName, String mDescription,
                      String mItemId,
     ...
     */
    public SubscriptionVG(JSONObject jsonObject) throws JSONException {
        super(jsonObject);
    }
    ...
    private static String TAG = "SOOMLA SubscriptionVG"; //used for Log messages
}
