...
public class ObscuredSharedPreferences implements SharedPreferences {
    ...
    private static final String SEKRIT = "SINC_SSEEKK";
    ...
    protected String encrypt( String value ) {
        ...
        try {
            ...
            SecretKey key = keyFactory.generateSecret(new PBEKeySpec((SEKRIT + SoomlaApp.getAppContext().getPackageName() + Settings.Secure.getString(context.getContentResolver(), Settings.Secure.ANDROID_ID)).toCharArray()));
